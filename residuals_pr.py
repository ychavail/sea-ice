##################################################################
# Description:
# Code name: residuals_pr.py
# Date of creation: 2019/01/18
# Date of last modification: 2019/01/18
...
for sim in simulations:
    ...
    filepath_r  = os.path.join(path, "pr_rearranged_{0}_{1}.nc".format(season,sim))
    ...
    mean.to_netcdf(('/exec/yanncha/sea_ice/pr/pr_mean_'+season+'_'+sim+'.nc'))
    std.to_netcdf(('/exec/yanncha/sea_ice/pr/pr_std_'+season+'_'+sim+'.nc'))
    sumrel.to_netcdf(('/exec/yanncha/sea_ice/pr/pr_sumrel_'+season+'_'+sim+'.nc'))
    ...
    file_txt = open('/home/yanncha/GitHub/sea-ice/outputs_from_code/residuals_pr.txt','a')
