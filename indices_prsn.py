##################################################################
# Description:
# Code name: indices_prsn.py
# Date of creation: 2019/02/18
# Date of last modification: 2019/02/18
...
for sim in simulations:
    ...
    filepath    = os.path.join(path, "prsn_rearranged_{0}_{1}.nc".format(season,sim))
    ...
    for y in years:
        ...
        file_txt = open('/home/yanncha/GitHub/sea-ice/outputs_from_code/indices_prsn.txt','a')
    ...
    max1j.to_netcdf(('/exec/yanncha/sea_ice/prsn/prsn_max1j_'+season+'_'+sim+'.nc'))
    max5j.to_netcdf(('/exec/yanncha/sea_ice/prsn/prsn_max5j_'+season+'_'+sim+'.nc'))
