##################################################################
# Description: Compute timeseries of the global sea ice extent in the Northern Hemisphere at its annual minimum from the 50 members of the CanESM2-LE ensemble. 
# Code name: compute_sie_september_timeseries.py
# Date of creation: 2018/03/28
# Date of last modification: 2018/04/05
...
outputfilename	= (outputdir+'sie_september_timeseries_CanESM2-LE_'+sim_family[0]+'.nc')
