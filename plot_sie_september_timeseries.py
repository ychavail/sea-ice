##################################################################
# Description: Plot timeseries of the global sea ice extent in the Northern Hemisphere at its annual minimum from the 50 members of the CanESM2-LE ensemble.
# Code name: plot_sie_september_timeseries.py
# Date of creation: 2018/04/06
# Date of last modification: 2018/04/06
...
nc1	= netcdf.Dataset('/exec/yanncha/abrupt_changes/sie_september_timeseries_CanESM2-LE_r1.nc','r')
nc2	= netcdf.Dataset('/exec/yanncha/abrupt_changes/sie_september_timeseries_CanESM2-LE_r2.nc','r')
nc3	= netcdf.Dataset('/exec/yanncha/abrupt_changes/sie_september_timeseries_CanESM2-LE_r3.nc','r')
nc4	= netcdf.Dataset('/exec/yanncha/abrupt_changes/sie_september_timeseries_CanESM2-LE_r4.nc','r')
nc5	= netcdf.Dataset('/exec/yanncha/abrupt_changes/sie_september_timeseries_CanESM2-LE_r5.nc','r')
...
plt.axis([1950,2100,0,2*10**14])
plt.ylabel('sea ice extent [m2]',fontsize=7)
plt.xticks([1950,1980,2010,2040,2070,2100],('','','','','',''),fontsize=7)
plt.yticks([0,0.5*10**14,10**14,1.5*10**14,2.0*10**14],('0.0','0.5','1.0','1.5','2.0e14'),fontsize=7)
...
plt.axis([1950,2100,0,2*10**14])
plt.xticks([1950,1980,2010,2040,2070,2100],('','','','','',''),fontsize=7)
plt.yticks([0,0.5*10**14,10**14,1.5*10**14,2.0*10**14],('','','','',''),fontsize=7)
...
plt.suptitle('Northern sea ice extent in September according to the CanESM2-LE under the RCP8.5 scenario',fontsize=10)

fig1.show()
fig1.savefig('/exec/yanncha/abrupt_changes/figures/sie_september_timeseries.eps',dpi=300)
