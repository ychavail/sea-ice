...
# Date of last modification: 2018/12/19
...
for sim in simulations:
    ...
    mean.to_netcdf(('/exec/yanncha/sea_ice/tasmax/tasmax_mean_'+season+'_'+sim+'.nc'))
    std.to_netcdf(('/exec/yanncha/sea_ice/tasmax/tasmax_std_'+season+'_'+sim+'.nc'))
    ...
    file_txt = open('/home/yanncha/GitHub/sea-ice/outputs_from_code/residuals_tasmax.txt','a')
