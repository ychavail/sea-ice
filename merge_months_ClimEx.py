##################################################################
# Description: ClimEx data is organized by months. In order to assess trends and
# extremes, we merge all timesteps and sorting data in 16 different squares
# over Quebec.
...
simulations = ["kdc","kdd","kde","kdf","kdg","kdh","kdi","kdj","kdk"]
var = "tasmax"
months = ("06","07","08","09")
