...
im = fct_p.map_contourfQC(fig3,111,ind0_max-ind1_max,lons,lats,('Dmax('+indice+'): no ice - ice [K]'),"",levels,infinity,palette)
fig3.subplots_adjust(right=0.8)
cbar_ax = fig3.add_axes([0.85, 0.3, 0.01, 0.4])
fig3.colorbar(im,cax=cbar_ax)
fig3.show()
fig3.savefig('/exec/yanncha/sea_ice/figures/'+indice+'_diffmax_map.png',dpi=300)
file_txt = open('/home/yanncha/GitHub/sea-ice/outputs_from_code/statistics_tasmax.txt','a')
